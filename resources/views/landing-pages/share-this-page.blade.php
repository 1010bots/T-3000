<x-app-layout theme-color="seafoam" title="Share Buttons">
    ...
    <main class="flex flex-col gap-4 px-safe-offset-6 py-6 text-center text-black dark:text-white">
        ...
        <ol class="flex flex-col gap-4">
            ...
            <li>
                <a href="https://github.com/1010bots/T-3000/commit/407afed088c5ae06d6998d0cb68e15333dafeac9"><strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">January 2024:</strong> 45</a><br>
            ...
            <li>
                <a href="https://github.com/1010bots/T-3000/commit/5d77080885759124b9316c239cdcda6667e2e45f"><strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">May 2024:</strong> 47</a><br>
