    ...
    <main class="flex flex-col gap-4 px-safe-offset-6 py-6 text-center text-black dark:text-white">
        ...
        <ol class="flex flex-col gap-4">
            ...
            <li>
                ...
                <p><strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">iOS, iPadOS, macOS:</strong> <span class="font-condensed">(Web Share API, Copy Link, Print, PDF, Embed, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Yahoo! Mail</strong>, Mastodon, KakaoStory, Messenger (Facebook), Pinterest, Flipboard, Pocket, Reddit, Hacker News, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Odnoklassniki</strong>, Blogger, Pleroma, Friendica, KakaoTalk, Snapchat, Misskey, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">XING</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Messages (iMessage)</strong>, LINE, Evernote, WhatsApp, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">LiveJournal</strong>, diaspora*, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Gmail</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Threads</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Threema</strong>, X, tumblr, Buffer, LinkedIn, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">mail.ru</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">VKontakte</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Trello</strong>, Facebook, Mail (Email), Skype, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Hatena Bookmark!</strong>, Twitter, Telegram, WordPress)</span></p>
                <p><strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Other platforms (Android, Linux, Windows, etc.):</strong> <span class="font-condensed">(Web Share API, Copy Link, Print, PDF, Embed, Email, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">SMS</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Yahoo! Mail</strong>, Mastodon, KakaoStory, Messenger (Facebook), Pinterest, Flipboard, Pocket, Reddit, Hacker News, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Odnoklassniki</strong>, Blogger, Pleroma, Friendica, KakaoTalk, Snapchat, Misskey, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">XING</strong>, LINE, Evernote, WhatsApp, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">LiveJournal</strong>, diaspora*, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Gmail</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Threads</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Threema</strong>, X, tumblr, Buffer, LinkedIn, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">mail.ru</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">VKontakte</strong>, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Trello</strong>, Facebook, Skype, <strong class="font-bold text-dm-seafoam-500 dark:text-dm-seafoam-200">Hatena Bookmark!</strong>, Twitter, Telegram, WordPress)</span></p>
            </li>
        </ol>
    </main>
</x-app-layout>
