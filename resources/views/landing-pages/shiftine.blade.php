<x-app-layout theme-color="blue" title="Shiftine (of Worlds and Nations)">
    <main class="flex flex-col gap-4 text-black dark:text-white">
        <div class="grid grid-cols-12 w-full p-safe-offset-4 gap-4">
            ...
            <x-primitives.card theme-color="indigo" class="flex flex-col col-span-12 md:col-span-6 lg:col-span-4 rounded-2xl overflow-hidden p-4">
            ...
            <x-primitives.card theme-color="cyan" class="flex flex-col col-span-12 md:col-span-6 lg:col-span-4 rounded-2xl overflow-hidden p-4">
