...
?>
<div class="flex flex-col flex-wrap gap-2 h-36 max-w-full overflow-x-scroll {{ $class ?? '' }}">
    <a id="{{ $unique_id }}-share-menu-open-share-sheet" class="text-center text-black dark:text-white bg-rc-violet-50 dark:bg-dm-violet-700 border-0 py-2 rounded-full leading-4 cursor-pointer">
        @if ($is_apple)
