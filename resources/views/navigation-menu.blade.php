...
<div>
    ...
    <dialog id="contact-card-dialog" class="p-0 rounded-xl bg-gray-100 dark:bg-gray-900 backdrop:bg-black/75 text-black dark:text-white border-0">
        ...
        <div class="flex flex-row flex-wrap align-center p-4 gap-4">
            <x-primitives.card theme-color="blue" class="h-card flex basis-0 grow flex-col p-3 gap-3 rounded-xl">
            ...
            <x-primitives.card theme-color="violet" class="h-card flex basis-0 grow flex-col p-3 gap-3 rounded-xl">
