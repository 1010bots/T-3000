...
class BlogPostController extends Controller
{
    ...
    public static function getPostById(string $id) {
        return Cache::remember("post-id-$id", 5 * 60, function () use ($id) {
    ...
    public static function getPostBySlug(string $slug, string|null $year = null, string|null $month = null, string|null $day = null) {
        return Cache::remember($year && $month && $day ? "post-$year-$month-$day-$slug" : "post-nd-$slug", 5 * 60, function () use ($slug, $year, $month, $day) {
